...
/**
 * Modelo para el error 404
 */
@Schema(description = "Modelo para el error 404")
@Validated
...
public class Error404   {
  ...
  public Error404 timestamp(String timestamp) {
  ...
  public Error404 error(String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.timestamp, error404.timestamp) &&
        Objects.equals(this.status, error404.status) &&
        Objects.equals(this.message, error404.message) &&
        Objects.equals(this.error, error404.error);
  }
